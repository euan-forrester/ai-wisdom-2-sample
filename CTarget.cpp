...
const float TargetMaxAngularVelocity            = 360.0f;       // Max angular velocity in degrees / second
const float TargetSteerToCenterOfWorldFactor    = 0.000001f;    // Amount to steer towards the center of the world
